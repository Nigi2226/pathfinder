                ...
                <label className="text-xs text-blue-600 cursor-pointer flex items-center gap-1 hover:underline">
                    ...
                    <input type="file" className="hidden" onChange={async (e) => {
                        ...
                        if (file) {
                            ...
                            try {
                                // Upload file first
                                // Use api instance to automatically attach Authorization header
                                // IMPORTANT: Let browser set Content-Type for FormData by deleting the default or passing correct config
